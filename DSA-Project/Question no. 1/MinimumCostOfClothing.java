public class MinimumCostOfClothing {
    public static int findMinimumCost(int[][] price) {
        ...
        int minCost1 = price[0][0]; // Minimum cost if person 1 wears clothing type 1
        int minCost2 = price[0][1]; // Minimum cost if person 1 wears clothing type 2
        int minCost3 = price[0][2]; // Minimum cost if person 1 wears clothing type 3

        // Calculate the minimum cost for each person while considering the previous choices
        for (int i = 1; i < N; i++) {
            int prevMinCost1 = minCost1; // Minimum cost for person i-1 wearing clothing type 1
            int prevMinCost2 = minCost2; // Minimum cost for person i-1 wearing clothing type 2
            int prevMinCost3 = minCost3; // Minimum cost for person i-1 wearing clothing type 3

            // Update the minimum cost for person i wearing each clothing type
        ...
        // Return the minimum cost among all possible choices
